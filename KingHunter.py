...
try:
    ...
    os.system('python2 KingHunter.py')
...
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mKingHunter.\033[1;91m┈┈┈┈  ╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mKingHunter\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............
 
\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
 
\033[1;91m☞ Auther     : Mafiya Sourav
\033[1;92m☞ WhatsApp   : 9971945685
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update MAFIYA_HUNTER Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' MAFIYA_HUNTER WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/MAFIYA_HUNTER')
	    os.system('cd $HOME && git clone https://github.com/Mafiyahunter/KingHunter.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 09971945685✓')
	    psb('WellCome To MAFIYA_HUNTER)
	    psb('Congratulations MAFIYA_HUNTER Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel B4 BALOCH M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/MAFIYA_HUNTER && python2 KingHunter.py')
	elif bm =='3':
